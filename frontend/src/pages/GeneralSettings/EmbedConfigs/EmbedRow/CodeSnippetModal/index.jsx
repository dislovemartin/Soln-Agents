...
https://github.com/Mintplex-Labs/solnai/tree/master/embed/README.md
-->
<script
  data-embed-id="${embed.uuid}"
  data-base-api-url="${serverHost}/api/embed"
  src="${scriptHost}/embed/solnai-chat-widget.min.js">
</script>
<!-- SolnAI (https://solnai.com) -->
`;
}
  ...
  return (
    <div>
      <div className="flex flex-col mb-2">
        ...
        <a
          href="https://github.com/Mintplex-Labs/solnai/tree/master/embed/README.md"
          target="_blank"
