...
export const ONBOARDING_SURVEY_URL = "https://onboarding.solnai.com";

export const AUTH_USER = "solnai_user";
export const AUTH_TOKEN = "solnai_authToken";
export const AUTH_TIMESTAMP = "solnai_authTimestamp";
export const COMPLETE_QUESTIONNAIRE = "solnai_completed_questionnaire";
export const SEEN_DOC_PIN_ALERT = "solnai_pinned_document_alert";
export const SEEN_WATCH_ALERT = "solnai_watched_document_alert";

export const APPEARANCE_SETTINGS = "solnai_appearance_settings";
