...
const TRANSLATIONS = {
  ...
  welcomeMessage: {
    part1:
      "Chào mừng đến với SolnAI, SolnAI is an open-source AI tool by Mintplex Labs that turns anything into a trained chatbot you can query and chat with. SolnAI is a BYOK (bring-your-own-keys) software so there is no subscription, fee, or charges for this software outside of the services you want to use with it.",
    part2:
