...
const SHOW_METRICS_KEY = "solnai_show_chat_metrics";
const SHOW_METRICS_EVENT = "solnai_show_metrics_change";
...
/**
 * Get the show metrics setting from localStorage `solnai_show_chat_metrics` key
 * @returns {boolean}
 */
...
/**
 * Toggle the show metrics setting in localStorage `solnai_show_chat_metrics` key
 * @returns {void}
 */
