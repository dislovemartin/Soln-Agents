...
5. Use the file `cloudformation_create_solnai.json` as your JSON template.
...
```
[+] Running 2/2
 ⠿ Network docker_solnai  Created 
 ⠿ Container solnai       Started  
```
