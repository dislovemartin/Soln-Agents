...
/**
 * An interface to the SolnAI Community Hub external API.
 */
const CommunityHub = {
  importPrefix: "allm-community-id",
  apiBase:
    process.env.NODE_ENV === "development"
      ? "http://127.0.0.1:5001/solnai-hub/us-central1/external/v1"
      : "https://hub.external.solnai.com/v1",
   ...
   * so we can unzip and import them to the SolnAI instance.
  ...
  /**
   * Apply an item to the SolnAI instance. Used for simple items like slash commands and system prompts.
  ...
  /**
   * Import a bundle item to the SolnAI instance by downloading the zip file and importing it.
