...
<p align="center">
  <a href="https://solnai.com"><img src="https://github.com/Mintplex-Labs/solnai/blob/master/images/wordmark.png?raw=true" alt="SolnAI logo"></a>
</p>

<div align='center'>
<a href="https://trendshift.io/repositories/2415" target="_blank"><img src="https://trendshift.io/api/badge/repositories/2415" alt="Mintplex-Labs%2Fsolnai | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>
</div>

<p align="center">
<b>SolnAI:</b> Aradığınız hepsi bir arada yapay zeka uygulaması.<br />
...
<p align="center">
  ...
  <a href="https://github.com/Mintplex-Labs/solnai/blob/master/LICENSE" target="_blank">
      <img src="https://img.shields.io/static/v1?label=license&message=MIT&color=white" alt="License">
  </a> |
  <a href="https://docs.solnai.com" target="_blank">
    Docs
  </a> |
   <a href="https://my.mintplexlabs.com/aio-checkout?product=solnai" target="_blank">
    Hosted Instance
  </a>
</p>
...
<p align="center">  
👉 Masaüstü için SolnAI (Mac, Windows ve Linux)! <a href="https://solnai.com/download" target="_blank"> Şimdi İndir</a>  
</p>  
...
![Mesajlaşma](https://github.com/Mintplex-Labs/solnai/assets/16845892/cfc5f47c-bd91-4067-986c-f3f49621a859)
...
- 💬 [Web sitenize gömülebilir özel sohbet aracı](https://github.com/Mintplex-Labs/solnai-embed/blob/main/README.md) _(Yalnızca Docker sürümünde)_  
...
- [xAI](https://x.ai/)
- [Novita AI (chat models)](https://novita.ai/model-api/product/llm-api?utm_source=github_solnai&utm_medium=github_readme&utm_campaign=link)
- [PPIO](https://ppinfra.com?utm_source=github_solnai)

**Embedder modelleri:**

- [SolnAI Native Embedder](/server/storage/models/README.md) (default)
- [OpenAI](https://openai.com)
- [Azure OpenAI](https://azure.microsoft.com/en-us/products/ai-services/openai-service)
...
- [SolnAI Built-in](https://github.com/Mintplex-Labs/solnai/tree/master/server/storage/models#audiovideo-transcription) (default)
- [OpenAI](https://openai.com/)
...
- **`embed`**: [Web gömme widget’ı](https://github.com/Mintplex-Labs/solnai-embed) oluşturma ve entegrasyonu için alt modül.  
- **`browser-extension`**: [Chrome tarayıcı eklentisi](https://github.com/Mintplex-Labs/solnai-extension) için alt modül.

## 🛳 Kendi Sunucunuzda Barındırma  

Mintplex Labs ve topluluk, SolnAI'i yerel olarak çalıştırmak için çeşitli dağıtım yöntemleri, betikler ve şablonlar sunmaktadır. Aşağıdaki tabloya göz atarak tercih ettiğiniz ortamda nasıl dağıtım yapabileceğinizi öğrenebilir veya otomatik dağıtım seçeneklerini keşfedebilirsiniz.
...
[veya Docker kullanmadan üretim ortamında SolnAI kurun →](./BARE_METAL.md)  
...
_Bu uygulamalar Mintplex Labs tarafından yönetilmemektedir, ancak SolnAI ile uyumludur. Burada listelenmeleri bir onay anlamına gelmez._  

- [Midori AI Alt Sistem Yöneticisi](https://io.midori-ai.xyz/subsystem/solnai/) - Docker konteyner teknolojisini kullanarak yapay zeka sistemlerini verimli bir şekilde dağıtmanın pratik bir yolu.  
- [Coolify](https://coolify.io/docs/services/solnai/) - Tek tıklamayla SolnAI dağıtımı yapmanıza olanak tanır.  
- [GPTLocalhost for Microsoft Word](https://gptlocalhost.com/demo/) - SolnAI’i Microsoft Word içinde kullanmanıza olanak tanıyan yerel bir Word eklentisi.

## Telemetri ve Gizlilik  

Mintplex Labs Inc. tarafından geliştirilen SolnAI, anonim kullanım bilgilerini toplayan bir telemetri özelliği içermektedir.  

<details>  
<summary><kbd>SolnAI için Telemetri ve Gizlilik hakkında daha fazla bilgi</kbd></summary>  

### Neden?  

Bu bilgileri, SolnAI’in nasıl kullanıldığını anlamak, yeni özellikler ve hata düzeltmelerine öncelik vermek ve uygulamanın performansını ve kararlılığını iyileştirmek için kullanıyoruz.  
...
[Kaynak kodda tüm telemetri olaylarını görüntüle](https://github.com/search?q=repo%3AMintplex-Labs%2Fsolnai%20.sendTelemetry\(&type=code)
...
[![solnai contributors](https://contrib.rocks/image?repo=mintplex-labs/solnai)](https://github.com/mintplex-labs/solnai/graphs/contributors)  

[![Star History Chart](https://api.star-history.com/svg?repos=mintplex-labs/solnai&type=Timeline)](https://star-history.com/#mintplex-labs/solnai&Date)  
...
[render-deploy]: https://render.com/deploy?repo=https://github.com/Mintplex-Labs/solnai&branch=render
[render-btn]: https://render.com/images/deploy-to-render-button.svg
[render-deploy]: https://render.com/deploy?repo=https://github.com/Mintplex-Labs/solnai&branch=render
...
[elestio-deploy]: https://elest.io/open-source/solnai
