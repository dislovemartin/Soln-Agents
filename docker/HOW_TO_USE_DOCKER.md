...
> [!TIP]
> Running SolnAI on AWS/GCP/Azure?
...
<table>
<tr>
<th colspan="2">Mount the storage locally and run SolnAI in Docker</th>
</tr>
<tr>
<td>
  Linux/MacOs
...
- `git clone` this repo and `cd solnai` to get to the root directory.
