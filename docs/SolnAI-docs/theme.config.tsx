...
const config: DocsThemeConfig = {
  ...
  docsRepositoryBase: 'https://github.com/Mintplex-Labs/SolnAI-docs/tree/main', // Repo link for the 'Edit this page'
  footer: {
    text: (
      <span>
  ...
  useNextSeoProps() {
    return {
      titleTemplate: '%s ~ SolnAI' // This is the text shown on the tab name, %s will show the title of current page
    }
  },
  sidebar: {
  ...
  head: function useHead() {
    ...
    const socialCard =
      route === '/' || !title
        ? 'https://docs.SolnAI.com/images/og.png'
        : `https://docs.SolnAI.com/api/og?title=${title}`
    ...
    return (
      <>
        ...
        <meta property="og:url" content="http://docs.SolnAI.com"></meta>
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:image" content={socialCard} />
        <meta name="twitter:site:domain" content="docs.SolnAI.com" />
        <meta property="twitter:title" content="SolnAI | The all-in-one AI desktop app." />
        ...
        <meta name="twitter:url" content="https://docs.SolnAI.com" />
        <meta name="og:title" content={title ? title + ' – SolnAI Docs' : 'SolnAI Docs'} />
        <meta name="og:image" content={socialCard} />
        <meta name="apple-mobile-web-app-title" content="SolnAI Docs" />
  ...
  banner: {
    ...
    text: (
      <a href="https://SolnAI.com/download" target="_blank">
        🚀 SolnAI {newRelease} is live! Update now →
      </a>
    )
  }
}
