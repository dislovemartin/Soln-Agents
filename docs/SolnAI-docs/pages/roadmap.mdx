---
title: "Roadmap"
description: "Feature & product roadmap for SolnAI Docker & Desktop"
---
...
At SolnAI, we're dedicated to making the most advanced LLM application available to everyone. We want to empower everyone to be able leverage LLMs for their own use for both non-technical and technical users.
...
- [x] The SolnAI Community Hub (sharing plugins, prompts, workspaces, etc.)
- [x] Private SolnAI Hub (sharing workspaces, prompts, plugins, etc. but private)
...
- [x] Simplified Token Tracking and monitoring sub-service (simple SDK that will be included in SolnAI Desktop & Docker)
