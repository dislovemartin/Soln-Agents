---
title: "502 Error on SolnAI Hosted"
...
<Callout type="warning" emoji="️⚠️">
  **Notice**
  This page only applies to the Hosted Cloud version of SolnAI and only applies to those using the built-in embedder model.
...
### I am getting a 502 on my hosted SolnAI!
...
<Image
  ...
  width={500}
  quality={100}
  alt="SolnAI Subscription Dashboard"
/>
...
<Image
  ...
  width={500}
  quality={100}
  alt="SolnAI Subscription Reboot"
/>
...
- [Switch to a cloud based embedder](/SolnAI-setup/embedder-configuration/overview#cloud-model-providers)
