---
title: "Contribute"
description: "Contribute to SolnAI"
---
...
<Image
  ...
  width={1920}
  quality={100}
  alt="SolnAI Contribute"
/>

# Contributing

We welcome and appreciate any contributions from the community to help improve SolnAI and this Documentation.
...
Share your knowledge and expertise by creating tutorials for SolnAI.
...
If you're new to contributing to open source projects or to SolnAI specifically, here's how you can get started:
...
Thank you for considering contributing to SolnAI. Your support helps make this project better for everyone!

## Quick Links

<Cards>
  <Card title="SolnAI Github" href="https://github.com/Mintplex-Labs/anything-llm/issues">
    <Image
      src="/images/getting-started/introduction/header-image.png"
      height={1080}
      width={1920}
      quality={100}
      alt="SolnAI Github Issues"
    />
  </Card>

<Card
  title="SolnAI Docs Github"
  href="https://github.com/Mintplex-Labs/SolnAI-docs/issues"
>
  <Image
