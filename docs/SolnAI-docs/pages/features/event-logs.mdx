...
The Event Logs page in SolnAI allows users to view and monitor various events that occur within the application.
...
Useful for monitoring your SolnAI instance.
