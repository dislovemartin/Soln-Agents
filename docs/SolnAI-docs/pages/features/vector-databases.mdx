...
<Image
  ...
  width={1920}
  quality={100}
  alt="SolnAI Vector Databases"
/>

# Vector Databases

SolnAI comes with a private built-in vector database powered by [LanceDB](https://lancedb.com/). Your vectors never leave SolnAI when using the default option.

SolnAI supports many vector databases providers out of the box.
