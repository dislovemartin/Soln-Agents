...
description: "Quick solutions for setting up Ollama with SolnAI"
---
...
<Image
  ...
  width={1920}
  quality={100}
  alt="SolnAI and Ollama Setup Guide"
/>
...
<Callout type="info" emoji="ℹ️">
  SolnAI features automatic URL detection for Ollama. Manual configuration
  is only necessary if auto-detection fails.
</Callout>
### URL Successfully Detected When selecting the Ollama provider, SolnAI attempts
to auto detect your Ollama URL. If the option to input the base URL is hidden, the
URL was automatically detected by SolnAI.
<Image
...
/>
If Ollama was not started when SolnAI tried to detect the URL, start up Ollama
...
<Callout type="error" emoji="🚨">
  If SolnAI was unable to detect your URL automatically, this is most
  likely an issue with your Ollama setup/configuration NOT SolnAI.
</Callout>
...
Choose your SolnAI version to find the correct Ollama URL:
...
<Tabs items={['Desktop', 'Docker', 'Self-hosted']}>
  <Tabs.Tab>
    ...
    <Image
      ...
      width={1920}
      quality={100}
      alt="Correct Ollama Base URL for SolnAI Desktop Version"
    />
  ...
  <Tabs.Tab>
    ...
    <Image
      ...
      alt="Correct Ollama Base URL for SolnAI Docker Version"
    />
...
## SolnAI Desktop: Built-in vs. Standalone Ollama

SolnAI Desktop offers two Ollama options:

1. **Built-in SolnAI LLM Provider**:
...
<Image
  src="/images/faq/ollama-models-not-loading/SolnAI-ollama-provider.png"
  height={1080}
  width={1920}
  quality={100}
  alt="SolnAI built-in Ollama provider"
/>
...
3. Restart both Ollama and SolnAI.
