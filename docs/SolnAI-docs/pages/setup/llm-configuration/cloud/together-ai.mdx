...
All Together AI models are currently available for use with SolnAI. [View the full list of models supported.](https://docs.together.ai/docs/inference-models#chat-models)

You can update your model to a different model at any time in the **Settings**.

<Image
  src="/images/SolnAI-setup/llm-configuration/cloud/together-ai/togetherai-llm.png"
  height={1080}
  width={1920}
  quality={100}
