...
All data pertaining to SolnAI Desktop will be in the following locations. Please replace `<usr>` with your
device username.

On Mac:
`/Users/<usr>/Library/Application Support/SolnAI-desktop/storage`

On Linux:
`/Users/<usr>/.config/SolnAI-desktop/storage/`

On Windows:
`C:\Users\<usr>\AppData\Roaming\SolnAI-desktop\storage`
...
- `SolnAI.db`: This is the SolnAI SQLite database.
