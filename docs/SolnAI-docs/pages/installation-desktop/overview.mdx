...
description: "SolnAI desktop is the easiest way to use SolnAI for most people."
---
...
SolnAI Desktop is a "**single-player**" application you can install on any Mac, Windows, or Linux operating system and get local LLMs, RAG, and Agents with little to zero configuration and full privacy.

## Docker vs Desktop Version

SolnAI offers two main ways to use SolnAI. There are some distinct differences in functionality between each offering. Both are open source.
