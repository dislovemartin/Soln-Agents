...
description: "SolnAI offers two main ways to use SolnAI. There are some distinct differences in functionality between each offering"
---
...
SolnAI Docker is both a **single-user** and **multi-user** application you can install on any webserver using docker and leverage local LLMs, RAG, and Agents with little to zero configuration and full privacy.

Self hosting SolnAI via Docker is very popular and can be done locally or on cloud servicers (aws, google cloud, railway etc..).

## Docker vs Desktop Version

There are some distinct differences in functionality between each offering. Both are open source.

### You want SolnAI Docker if...

- You need an easy setup, but server-based service for SolnAI to use local LLMs, RAG, and Agents locally
- You want to run an SolnAI instance that many people can use at the same time
...
- You want to access SolnAI from the browser

### You want SolnAI Desktop if...
...
<Callout type="info" emoji="️💡">
  **Tip:** SolnAI Desktop is the easiest way to use SolnAI.
</Callout>
...
<Cards>
  <Card title="System Requirements" href="system-requirements">
    <Image
      ...
      width={1920}
      quality={100}
      alt="SolnAI System Requirements"
    />
  </Card>
...
<Card title="Local Docker Install" href="/installation-docker/local-docker">
  <Image
    ...
    width={1920}
    quality={100}
    alt="SolnAI Local Docker Install"
  />
</Card>
...
>
  ...
  <Card title="Cloud Docker Install" href="/installation-docker/cloud-docker">
    <Image
      ...
      width={1920}
      quality={100}
      alt="SolnAI Cloud Docker Install"
    />
  </Card>
</Cards>
